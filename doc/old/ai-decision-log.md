...
- `doc/PR_DRAFT_PHASE_A.md` contains the comprehensive PR description.
- Branch `phase-a/sprint-0-planning-baseline` has been pushed to GitHub.
- Pull request creation is pending; use the GitHub compare URL and `doc/PR_DRAFT_PHASE_A.md`.
